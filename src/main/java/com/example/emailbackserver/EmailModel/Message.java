...
public class Message implements Cloneable{
    ...
    public Message(String from, String[] to, String subject, String body, String date) {
        this.from = from;
        this.to = to;
        this.subject = subject;
        this.body = body;
    ...
    public boolean equals(Object obj) {
        ...
        return this.id.equals(m.id) && this.from.equals(m.from) && Arrays.equals(this.to, m.to) && this.subject.equals(m.subject) &&
                this.body.equals(m.body) && this.attachment.equals(m.attachment) && this.read == m.read &&
